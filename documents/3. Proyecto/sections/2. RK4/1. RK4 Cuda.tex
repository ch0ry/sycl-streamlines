...
No obstante, tras un análisis inicial del código, se optó por intercambiar la libería NRRD por HDF5, como sugerencia del director y autor del código, puesto que HDF5 posee características que se adecúan más a su uso en un contexto de computación heterogénea, como lectura/escritura paralela basada en MPI. Tras este cambio, asumimos esta implementación como un punto de referencia, para derivar las implementaciones en HIP y SYCL.
